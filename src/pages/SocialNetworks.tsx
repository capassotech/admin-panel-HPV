    ...
    >
      <div className="p-6">
        <h3 className="text-lg font-medium mb-4">
          {social ? "Edit Social Network" : "Add New Social Network"}
        </h3>
...
const SocialNetworks = () => {
  ...
  const handleDeleteSocial = (social) => {
    if (window.confirm(`Are you sure you want to delete ${social.name}?`)) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Social Networks</h1>
          <p className="text-muted-foreground">
            Manage your social media links and website.
          </p>
        </div>
          ...
          {socials.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-muted-foreground">
                Get started by adding a new social network.
              </p>
